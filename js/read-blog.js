            ...
            `
                <div class="block py-lg-4 px-lg-4 box-shadow comment-card card br-3 px-lg-4 mt-lg-4">   
                    ...
                    <div class="block text-right pt-lg-4">
                        <div class="share inline-block  mx-3 mx-md-3 mx-lg-3 pointer like" id="${comment._id}">
                            <span class="clr-red pointer"  id="${comment._id}">
                                <svg  id="${comment._id}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                        ...
                        <div class="share inline-block  mx-3 mx-md-3 mx-lg-3 pointer disLike" id="${comment._id}">
                            <span class="clr-red pointer"  id="${comment._id}">
                                <svg  id="${comment._id}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
...
const likeBlog = async(commentId)=>{
    try{
        const {data} = await axios.put(
            `http://localhost:3000/api/${currentId}/comments/${commentId}/like`,{},
            {
                headers: {
